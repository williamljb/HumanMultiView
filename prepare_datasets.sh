...
# python -m src.datasets.mpi_inf_3dhp_to_tfrecords --split val --data_directory $MPI_INF_3DHP_DIR --output_directory $DATA_DIR/mpi_inf_3dhp
# python -m src.datasets.mpi_inf_3dhp_test_to_tfrecords --data_directory $MPI_INF_3DHP_DIR --output_directory $DATA_DIR/mpi_inf_3dhp

# ----- synthetic -----
python -m src.datasets.synthetic_to_tfrecords --data_directory $SYNTHETIC_DIR --output_directory $DATA_DIR/synthetic
# python -m src.datasets.synthetic_to_tfrecords --split val --data_directory $SYNTHETIC_DIR --output_directory $DATA_DIR/synthetic

# ----- COCO -----
# python -m src.datasets.coco_to_tfrecords --data_directory /scratch1/hmr_multiview/coco/data --output_directory $DATA_DIR/coco



# ----- Mosh data, for each dataset -----
# CMU:
# python -m src.datasets.smpl_to_tfrecords --dataset_name 'neutrSMPL_CMU'

# # H3.6M:
# python -m src.datasets.smpl_to_tfrecords --dataset_name 'neutrSMPL_H3.6'

# # jointLim:
# python -m src.datasets.smpl_to_tfrecords --dataset_name 'neutrSMPL_jointLim'
